    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                <s:message code="toudi.message1"/> </h1>
                </dt>
                ...
                <dd>
                    <form id="searchForm">
                        ...
                        <ul class="reset my_jobs">
                            <li data-id="149594">
                                <h3>
                                    <a target="_blank"  href="">${deliver.name}/${deliver.post}</a>
                                </h3>
                                <div> ${deliver.sex}/ ${deliver.major}/ ${deliver.education}</div>
                                <div class="links">
                                    <a target="_blank" class="job_edit" href="<%=Const.ROOT%>download?filename=${deliver.resume}"><s:message code="toudi.message2"/></a>
                                    <a target="_blank" class="job_edit" href="<%=Const.ROOT%>deliver/doupdate?id=${deliver.id}"><s:message code="toudi.message3"/></a>
                                </div>
                            </li>
                        </ul>
                        </c:forEach>
