...
<head>
    ...
    <title><s:message code="addcreate.message1"/></title>
    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                   <s:message code="addcreate.message1"/>
                </h1>
                </dt>
                <dd>
                    <div class="ccc_tr"></div>
                    <form action="<%=Const.ROOT%>post/doupdate" method="post" id="jobForm">
                        <table class="btm">
                            <tbody>
                            <tr>
                                <td><span class="redstar">*</span></td>
                                <td><s:message code="addcreate.message2"/></td>
                                <td>
                                    <input type="text" required placeholder="<s:message code="addcreate.message3"/>" value="${post.post}" name="post"
                                           id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><s:message code="addcreate.message4"/></td>
                                <td>
                                    <input type="text" placeholder="<s:message code="addcreate.message5"/>" value="${post.num}" name="num" id="department">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><s:message code="addcreate.message6"/></td>
                                <td>
                                    <input type="text" placeholder="<s:message code="addcreate.message7"/>" value="${post.salary}" name="salary">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                <td><span class="redstar">*</span></td>
                                <td><s:message code="addcreate.message8"/></td>
                                <td>
                                    <input type="hidden" id="education" value="${post.education}" name="education">
                                    <input type="hidden" id="id" value="${post.id}" name="id">
                                    <input type="button" value="<s:message code="addcreate.message9"/>" id="select_education"
