...
<head>
    ...
    <title><s:message code="addNote.message1"/></title>
    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                    <s:message code="addNote.message1"/>
                </h1>
                </dt>
                <dd>
                    <div class="ccc_tr"></div>
                    <form action="<%=Const.ROOT%>note/doadd" method="post" id="jobForm">
                        <table class="btm">
                            <tbody>
                            <tr>
                                <td><span class="redstar">*</span></td>
                                <td><s:message code="addNote.message2"/>:</td>
                                <td>
                                   <textarea name="unote" placeholder="<s:message code="addNote.message3"/>" value=""></textarea>
                                </td>
                            </tr>
                            </tbody>
                        </table>
