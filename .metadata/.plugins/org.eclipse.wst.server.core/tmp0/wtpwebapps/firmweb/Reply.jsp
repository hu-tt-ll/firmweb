...
<head>
    ...
    <title><s:message code="reply.message1"/></title>
    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <h1>
                    <em></em>
                    <s:message code="reply.message1"/> </h1>
                </dt>
                <dd>
                    <form id="searchForm">
                        <c:forEach var="reply" items="${requestScope.replys}" varStatus="status">
                            <ul class="reset my_jobs">
                                <li data-id="149594">
                                    <h3>
                                        <s:message code="reply.message2"/>：<a href="javascript:void(0)">${reply.rname}</a>
                                    </h3>
                                    <div> <s:message code="note.message3"/>：${reply.fnote}</div>
                                    <div> <s:message code="note.message4"/>：${reply.ftime}</div>
                                    <div class="links">
                                    </div>
                                </li>
                            </ul>
