        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <dd>
                    ...
                    <form action="<%=Const.ROOT%>post/doadd" method="post" id="jobForm">
                        <table class="btm">
                            <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" placeholder="<s:message code="addcreate.message3"/>" value="" name="post"
                                           id="positionName" required>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>
                                    <input type="text"  placeholder="<s:message code="addcreate.message5"/>" value="" name="num" id="department">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>
                                    <input type="text"  placeholder="<s:message code="addcreate.message7"/>" value="" name="salary">
                                </td>
                            </tr>
                            </tbody>
                        </table>
